    ...
    <div class="background-round__inner">
     <div class="section-container type1">
      ...
      <p class="b-m60 text-center_pc">
       本ページに掲載されているサイトは、ポートフォリオ用に作成したサンプルサイトです。<br>現在の職務における制作物については、守秘義務の観点から掲載は控えておりますため、<br class="pcbr">デザインやコーディングスキルをお伝えする目的で独自に作成したサンプルを掲載しています。
      </p>
     ...
     <div class="section-container">
      ...
      <section id="area01" class="hide-area">
       ...
       <p class="b-m20">人材育成という無形商材を扱う特性を活かし、スタイリッシュでプロフェッショナルな印象を与えるデザインを意識しました。<br>ユーザーがスムーズにお問い合わせに進めるよう、UI/UXに配慮し、コンテンツの配置やリンクボタンの配色を最適化しています。</p>
      ...
      <section id="area02" class="hide-area">
       ...
       <p class="b-m20">温かみのあるオレンジを基調に、子どもたちや地域に親しみやすいデザインを採用しました。<br>直感的なナビゲーションを意識し、訪問者が迷わず目的の情報やお問い合わせにたどり着けるよう、シンプルでわかりやすいUIを実現しています。また、画像やイラストを活用することで視覚的な楽しさも演出しました。</p>
